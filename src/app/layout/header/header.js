...
//     Container, InputGroup, InputGroupAddon, Input, InputGroupText
// } from 'reactstrap';
import {
                    ...
                    <Collapse isOpen={this.state.isOpen} navbar className="justify-content-end">
                        <form>
                            <InputGroup className="no-border">
                                ...
                                <InputGroupAddon addonType="prepend"><InputGroupText><i className="now-ui-icons ui-1_zoom-bold"></i></InputGroupText></InputGroupAddon>
                            </InputGroup>
                        </form>
                        <Nav navbar>
                            <NavItem>
